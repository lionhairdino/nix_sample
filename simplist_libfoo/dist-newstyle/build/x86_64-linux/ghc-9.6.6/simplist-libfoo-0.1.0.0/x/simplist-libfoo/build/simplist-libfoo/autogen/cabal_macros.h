...
/* package simplist-libfoo-0.1.0.0 */
#ifndef VERSION_simplist_libfoo
#define VERSION_simplist_libfoo "0.1.0.0"
#endif /* VERSION_simplist_libfoo */
#ifndef MIN_VERSION_simplist_libfoo
#define MIN_VERSION_simplist_libfoo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_simplist_libfoo */
...
#define CURRENT_COMPONENT_ID "simplist-libfoo-0.1.0.0-inplace-simplist-libfoo"
